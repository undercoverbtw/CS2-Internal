...
private:
	void* GetEntityByIndex(int nIndex)
	{
		...
		static auto GetBaseEntity = reinterpret_cast<fnGetBaseEntity>(memory::find_pattern(xorstr_(L"client.dll"), xorstr_("81 FA ? ? ? ? 77 ? 8B C2 C1 F8 ? 83 F8 ? 77 ? 48 98 48 8B 4C C1 ? 48 85 C9 74 ? 8B C2 25 ? ? ? ? 48 6B C0 ? 48 03 C8 74 ? 8B 41 ? 25 ? ? ? ? 3B C2 75 ? 48 8B 01")));
